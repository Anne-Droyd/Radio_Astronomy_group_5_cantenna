...
class group5_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "group5_test")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*vec_len, 'data8_veclen2048', False)
...
def main(top_block_cls=group5_test, options=None):
